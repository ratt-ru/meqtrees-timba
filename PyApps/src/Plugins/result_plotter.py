...
# retrieve it
    ...
    (metrics_rank, iteration_number, solver_divides) = self._solver_data.getSolverMetrics()
    self._visu_plotter.set_solver_metrics(metrics_rank, iteration_number, solver_divides)
