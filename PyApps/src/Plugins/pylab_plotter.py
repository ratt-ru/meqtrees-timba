...
# Gratefully adapted from the matplotlib example: embedding_in_qt.py
...
# back to 'real' work
  ...
  def create_layout_stuff(self):
    ...
    if self.layout_parent is None or not self.layout_created:
      self.layout_parent = QWidget(self.wparent(),"layout parent")
...
Grid.Services.registerViewer(meqds.NodeClass(),PylabPlotter,priority=22)
