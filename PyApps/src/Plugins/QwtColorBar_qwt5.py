...
#% $Id: QwtColorBar.py 6419 2008-10-03 10:17:35Z oms $ 
...
#       if abs(max - min) < 0.00005:
    ...
    def setScales(self):
      ...
      if self.log_scale:
        self.setAxisOptions(Qwt.QwtPlot.yLeft, Qwt.QwtAutoScale.Floating | QwtAutoScale.Logarithmic)
#     else:
...
# should not be any such menuid that we need to handle here
    ...
    def setPosition(self, position):
      ...
      if not self.xzoom_loc is None:
        ...
        # starting a drag.
        if self.xpos < self.xlb-10 or self.xpos > self.xhb+10 or self.ypos > self.ylb+10 or self.ypos < self.yhb-10:
          self.startDrag()
    # onMouseMoved()
