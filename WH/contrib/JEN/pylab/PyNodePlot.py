...
class PyNodePlotCrossCorrs22 (PyNodePlotCoh22):
  """Class derived from PyNodePlot."""

  def __init__ (self, *args, **kwargs):
    PyNodePlotCoh22.__init__(self, *args);
    return None
  ...
  def help (self, ss=None, level=0, mode=None):
    """
    Version of PyNodePlotCoh22 that only plots the cross-correlations
    (i.e. index 1 and 2). By default, annotate=True.
    """
    ss = self.attach_help(ss, PyNodePlotCrossCorrs22.help.__doc__,
                          classname='PyNodePlotCrossCorrs22',
                          level=level, mode=mode)
    return PyNodePlotCoh22.help(self, ss, level=level+1, mode=mode) 
  ...
  def check_plotinfo (self, trace=False):
    ...
    # Then do the generic checks (mandatory!) 
    PyNodePlotCoh22.check_plotinfo(self, trace=trace)
...
class PyNodePlotXY (PyNodePlot):
  ...
  def help (self, ss=None, level=0, mode=None):
    ...
    """
    ss = self.attach_help(ss, PyNodePlotXY.help.__doc__,
                          classname='PyNodePlotXY',
                          level=level, mode=mode)
    return PyNodePlot.help(self, ss, level=level+1, mode=mode) 
...
class PyNodePlotUV (PyNodePlotXY):
  """Class derived from PyNodePlotXY"""

  def __init__ (self, *args, **kwargs):
    PyNodePlotXY.__init__(self, *args);
    return None
  ...
  def help (self, ss=None, level=0, mode=None):
    """
    Version of PyNodePlotXY, used for plotting uv-points.
    """
    ss = self.attach_help(ss, PyNodePlotUV.help.__doc__,
                          classname='PyNodePlotUV',
                          level=level, mode=mode)
    return PyNodePlotXY.help(self, ss, level=level+1, mode=mode) 
  ...
  def check_plotinfo (self, trace=False):
    ...
    # Then do the generic checks (mandatory!) 
    PyNodePlotXY.check_plotinfo(self, trace=trace)
    return None


#=====================================================================

class PyNodePlotXXYY (PyNodePlot):
  """Class derived from PyNodePlot"""
  ...
  def help (self, ss=None, level=0, mode=None):
    ...
    """
    ss = self.attach_help(ss, PyNodePlotXXYY.help.__doc__,
                          classname='PyNodePlotXXYY',
                          level=level, mode=mode)
    return PyNodePlot.help(self, ss, level=level+1, mode=mode) 
...
class PyNodePlotXYZ (PyNodePlot):
  """Class derived from PyNodePlot"""
  ...
  def help (self, ss=None, level=0, mode=None):
    ...
    """
    ss = self.attach_help(ss, PyNodePlotXYZ.help.__doc__,
                          classname='PyNodePlotXYZ',
                          level=level, mode=mode)
    return PyNodePlot.help(self, ss, level=level+1, mode=mode) 
...
class PyNodePlotXYZZ (PyNodePlot):
  """Class derived from PyNodePlot"""
  ...
  def help (self, ss=None, level=0, mode=None):
    ...
    """
    ss = self.attach_help(ss, PyNodePlotXYZZ.help.__doc__,
                          classname='PyNodePlotXYZZ',
                          level=level, mode=mode)
    return PyNodePlot.help(self, ss, level=level+1, mode=mode) 
...
class PyNodePlotXXYYZZ (PyNodePlot):
  """Class derived from PyNodePlot"""
  ...
  def help (self, ss=None, level=0, mode=None):
    ...
    """
    ss = self.attach_help(ss, PyNodePlotXXYYZZ.help.__doc__,
                          classname='PyNodePlotXXYYZZ',
                          level=level, mode=mode)
    return PyNodePlot.help(self, ss, level=level+1, mode=mode) 
...
def _define_forest (ns,**kwargs):
  ...
  if False:
    ...
    if 1:
      ...
      if 1:
        ...
        name = classname
        classnames[name] = classname
        rr[name] = rr['PyNodePlotXY']
        rr[name]['title'] = name
        children[name] = children['PyNodePlotXY']
  ...
  if False:
    ...
    name = classname+'m'              # minimal PyNodePlot
    cc = []
    labels = []
    yname = 'y1m'
    xname = 'x1m'
  ...
  if False:
    ...
    # Concatenation of all PyNodePlot nodes:
