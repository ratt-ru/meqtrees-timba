...
# History:
# - 14sep2007: creation (from Grow.py)

# Description:

"""The Grow class is the base-class from which an entire zoo of classes
are derived that make an input 'tree' grow by making its root node(s) the
child(ren) of a new (set of) node(s). 
It conveniently takes care of TDLOption
manipulation, input and output checking, visualization etc.
Grow is a base-class from which a veritable zoo of GrowDoSomething
classes are derived, and also other base-clsses like GrowLeaf and
GrowDemo.
"""
...
class Grow (object):
    """The Grunt Grow class allows the user to specify and generate
    ...
    def __init__(self, quals=None,
        ...
        # and format. It may be used by Grows to do the correct thing.
        # This dict should be updated when the data type or format changes,
        # using self.datadesc(). It should be passed down a chain of Grows.
    ...
    def make_name_and_submenu (self, name=None, submenu=None, quals=None):
        ...
        # Qualifiers allow the same Grow to be used multiple
    ...
    def change_submenu(self, submenu, trace=True):
        ...
        This is done when an existing Grow object is attached to
        another one."""
    ...
    def ignore (self, ignore=None):
        ...
        - If ignore==True, the Grow submenu will hidden, and no subtree
        will be generated by .grow()
        - If ignore==False, the Grow submenu will become visible, and
        .grow() will do its thing.
        """
    ...
    #====================================================================
    # Some service(s) available to all classes derived from Grow:
    #====================================================================
    ...
    def on_input (self, ns, input=None, severe=True,
        ...
        if self._ignore:
            if trace:
                print s,'ignored'
            return False            # This will cause .grow() to exit
    ...
    def on_output (self, result, severe=True,
                   internodes=None, allnodes=None,
                   trace=False):
        """Generic function that should be called at the end of the
        specific function .grow() in a derived class.
        ...
        - The list 'allnodes' contains all intermediary nodes, which may be
        ...
        # Check the result node of this Grow:
    ...
    def define_generic_misc_options(self):
        ...
        if len(self._mode.keys())>0:
            self._OM.define(self.optname('misc.mode'), None,
                            ...
                            doc="""The Grow option values may be preset
    ...
    def define_generic_visu_options(self):
        ...
        self._OM.define(self.optname('misc.visu.bookpage'), self.name,
                        ...
                        generated for this Grow. If bookpage==None,
                        visualization for this Grow object is inhibited.
                        """)
    ...
    def define_visu_options(self):
        ...
        self._OM.define(self.optname('misc.visu.allnodes'), False,
                        ...
                        of this Grow, e.g. for debugging.
                        """)
        return True
    ...
    # See also the derived class GrowTest below, and GrowTemplate.py
    #=====================================================================================
    #=====================================================================================
...
class GrowTest(Grow):
    ...
    def __init__(self, quals=None,
        ...
        Grow.__init__(self, quals=quals,
                      name='GrowTest',
                      submenu=submenu,
...
def _tdl_job_display (mqs, parent):
    """Just display the current contents of the Grow object"""
