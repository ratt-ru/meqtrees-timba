...
def twig_names (cat='default', include=None, first=None, trace=False):
    ...
    if trace:
        print '** QuickRefUtil.twig_names(',cat,include,' first=',first,'):',names
    return names
...
def twig(ns, name, test=False, trace=False):
    ...
    """
    s1 = '** QuickRefUtil.twig('+str(name)+', test='+str(test)+'):'
