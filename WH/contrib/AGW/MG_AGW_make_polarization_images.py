...
# read in beam images
  ...
  infile_name_re_yx = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/yx_real.fits'
  infile_name_im_yx = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/yx_imag.fits'
  infile_name_re_yy = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/yy_real.fits'
  infile_name_im_yy = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/yy_imag.fits' 
  ...
  infile_name_re_xx = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/xx_real.fits'
  infile_name_im_xx = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/xx_imag.fits'
  infile_name_re_xy = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/xy_real.fits'
  infile_name_im_xy = home_dir + '/Timba/WH/contrib/AGW/veidt_stuff/xy_imag.fits'
