...
# History:
# - 19 Sept 2006: first version checked in
...
def _define_forest (ns):
  ...
  """;
# set up a sequence of nodes for testing of the ParAngle node
...
####
# Make cells array - we will compute Parallactic Angle over a period
