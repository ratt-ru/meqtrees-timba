...
def _define_forest(ns):  
  ...
  ns.pynode << Meq.PyNode(file_name = mep_beam_weights, class_name=classname, module_name=__file__) 
  ...
  # but the results of the fits seem fairly reasonable.
    ...
    ns.req_seq<<Meq.ReqSeq(ns.parms_req_mux, ns.solver_I_max, ns.solver, ns.Ins_pol,ns.pynode)
  else:
    ns.req_seq<<Meq.ReqSeq(ns.parms_req_mux, ns.solver_I_max, ns.Ins_pol,ns.pynode)
