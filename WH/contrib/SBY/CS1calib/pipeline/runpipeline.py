...
TDLRuntimeOption('min_spwid',"Start subband",[1,2,3]);
TDLRuntimeOption('max_spwid',"End subband",[1,2,3,4,5,6]);
...
TDLRuntimeOption('tile_size',"Tile size",[1,10,30,48,60,96,480]);
...
TDLCompileOption('ph_center',"Phase Cen",["CasA","CygA"]);

#### imaging options ####
TDLRuntimeOption('full_images',"Full Images",[True,False]);
