...
from Timba.Contrib.MXM.MimModule.KL import MyKLNode
import Meow
...
##        return self.ns['mim_phase'];
    ...
    def create_KL_node(self):
        ...
        kl=self.ns['KL_node']()  <<  Meq.PyNode(children=(parms,pps),class_name="KLNode",module_name="Timba.Contrib.MXM.MimModule.KL.MyKLNode",
                                           rank=rank);
        return kl;
