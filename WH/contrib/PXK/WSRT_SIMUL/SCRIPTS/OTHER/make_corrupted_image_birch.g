...
func make_corrupted_img_1chan(file, im_size, chan){
    ...
    file_fts:= paste(file, '.FITS',  sep='')

    cell_x  := 4.0
    cell_y  := 4.0

    print "Make Image From Corrected Data Stokes IQUV "
    ...
    mdd1.setoptions([titletext="PXK",titletextcolor="green"])
