...
TDLCompileOption('N_ANT',"Number of stations",[20,27,36,49],more=float)
...
# solvable G Jones
meqmaker.add_uv_jones('G','solve for receiver gains/phases',
...
# Last but not least, very important -- insert meqmaker's options properly
