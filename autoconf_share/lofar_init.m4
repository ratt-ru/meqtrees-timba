...
[
  ...
  *_*)
  ...
  # Keep the old lofar_config.h file for the case that it does not change.
  # (in that way no recompile will be done).
  touch lofar_config.h.orig
  if [ -e lofar_config.h ]; then
    mv lofar_config.h lofar_config.h.orig
  fi
  ...
  echo "/* Generated by lofarconf */" >> lofar_config.h
  echo "#ifndef LOFAR_CONFIG_H" >> lofar_config.h
  echo "#define LOFAR_CONFIG_H" >> lofar_config.h
  echo "" >> lofar_config.h
