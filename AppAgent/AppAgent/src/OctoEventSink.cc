...
bool EventSink::init (const DMI::Record &data)
{
...
int EventSink::getDefaultScope (const DMI::Record &map)
{
...
int EventSink::getDefaultPriority (const DMI::Record &map)
{
...
void EventSink::setReceiveMap (const DMI::Record &map)
{
  receive_map.clear();
...
void EventSink::setPostMap (const DMI::Record &map)
{
  post_map.clear();
  // interpret Default.Scope argument
  int defscope = getDefaultScope(map);
