...
const DMI::TypeId TpMeqCompiledFunklet(-1579);    // from /home/mevius/exp_parm/LOFAR/Timba/MeqNodes/src/CompiledFunklet.h:18
const int TpMeqCompiledFunklet_int = -1579;
