//# EMFPar.h: Calculate EMFPar of a source from J2000 Ra, Dec
//#
...
//#
//# $Id: EMFPar.h 5418 2007-07-19 16:49:13Z oms $

// A MeqEMFPar node transforms Right Ascension and Declination coordinates 
...
// A MeqEMFPar node can be set up by specifying the following field in its 
// init-record: 
...
#ifndef MEQNODES_EMFPAR_H
#define MEQNODES_EMFPAR_H
...
#pragma types #Meq::EMFPar
#pragma aid AzEl XYZ H

namespace Meq {    



class EMFPar : public TensorFunction
{
public:
  EMFPar();
...
protected:
  ...
  // method required by TensorFunction
  // Evaluates EMFPar for a given set of children values
