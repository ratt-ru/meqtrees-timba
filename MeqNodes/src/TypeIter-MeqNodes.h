...
#define DoForAllDynamicTypes_MeqNodes(Do,arg,separator) \
        ...
        Do(Meq::VisPhaseShift,arg) separator \
        Do(Meq::WMean,arg) separator \
        Do(Meq::WSRTCos3Beam,arg) separator \
