...
Thread::Mutex ParmTable::static_table_mutex_;
std::map<string, ParmTable*> ParmTable::open_tables_;

InitDebugContext(ParmTable,"ParmTable");

//##ModelId=3F95060D033E
ParmTable* ParmTable::openTable (const string& tablename,int type)
{
