...
DMI::BObj * __construct_MeqCompounder (int n) { return n>0 ? new Meq::Compounder [n] : new Meq::Compounder; }
#include "Condeq.h"
...
#include "EMFPar.h"
DMI::BObj * __construct_MeqEMFPar (int n) { return n>0 ? new Meq::EMFPar [n] : new Meq::EMFPar; }
#include "Exp.h"
...
#include "Identity.h"
DMI::BObj * __construct_MeqIdentity (int n) { return n>0 ? new Meq::Identity [n] : new Meq::Identity; }
#include "Imag.h"
...
#include "LMRaDec.h"
DMI::BObj * __construct_MeqLMRaDec (int n) { return n>0 ? new Meq::LMRaDec [n] : new Meq::LMRaDec; }
#include "Log.h"
...
#include "ParAngle.h"
DMI::BObj * __construct_MeqParAngle (int n) { return n>0 ? new Meq::ParAngle [n] : new Meq::ParAngle; }
#include "Parm.h"
...
#include "PatchComposer.h"
DMI::BObj * __construct_MeqPatchComposer (int n) { return n>0 ? new Meq::PatchComposer [n] : new Meq::PatchComposer; }
#include "Polar.h"
...
#include "Stokes.h"
DMI::BObj * __construct_MeqStokes (int n) { return n>0 ? new Meq::Stokes [n] : new Meq::Stokes; }
#include "Stripper.h"
...
DMI::BObj * __construct_MeqUVInterpol (int n) { return n>0 ? new Meq::UVInterpol [n] : new Meq::UVInterpol; }
...
#include "VisPhaseShift.h"
DMI::BObj * __construct_MeqVisPhaseShift (int n) { return n>0 ? new Meq::VisPhaseShift [n] : new Meq::VisPhaseShift; }
#include "WMean.h"
...
DMI::BObj * __construct_MeqZeroFlagger (int n) { return n>0 ? new Meq::ZeroFlagger [n] : new Meq::ZeroFlagger; }
    ...
    int aidRegistry_MeqNodes ()
    {
      static int res = 
        ...
        AtomicID::registerId(-1717,"MeqCoordTransform")+
        TypeInfoReg::addToRegistry(-1717,TypeInfo(TypeInfo::DYNAMIC,0))+
        DynamicTypeManager::addToRegistry(-1717,__construct_MeqCoordTransform)+
        ...
        AtomicID::registerId(-1762,"MeqEMFPar")+
        TypeInfoReg::addToRegistry(-1762,TypeInfo(TypeInfo::DYNAMIC,0))+
        DynamicTypeManager::addToRegistry(-1762,__construct_MeqEMFPar)+
        AtomicID::registerId(-1711,"AzEl")+
        ...
        AtomicID::registerId(-1690,"MeqFITSDataMux")+
        TypeInfoReg::addToRegistry(-1690,TypeInfo(TypeInfo::DYNAMIC,0))+
        DynamicTypeManager::addToRegistry(-1690,__construct_MeqFITSDataMux)+
        AtomicID::registerId(-1576,"Filename")+
        AtomicID::registerId(-1648,"CutOff")+
        ...
        AtomicID::registerId(-1574,"MeqHistoryCollect")+
        TypeInfoReg::addToRegistry(-1574,TypeInfo(TypeInfo::DYNAMIC,0))+
        DynamicTypeManager::addToRegistry(-1574,__construct_MeqHistoryCollect)+
        AtomicID::registerId(-1575,"History")+
        ...
        AtomicID::registerId(-1591,"MeqResampler")+
        TypeInfoReg::addToRegistry(-1591,TypeInfo(TypeInfo::DYNAMIC,0))+
