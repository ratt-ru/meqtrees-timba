...
DMI::BObj * __construct_MeqCompiledFunklet (int n) { return n>0 ? new Meq::CompiledFunklet [n] : new Meq::CompiledFunklet; }
    ...
    int aidRegistry_MeqNodes ()
    {
      static int res = 
        ...
        AtomicID::registerId(-1579,"MeqCompiledFunklet")+
        TypeInfoReg::addToRegistry(-1579,TypeInfo(TypeInfo::DYNAMIC,0))+
        DynamicTypeManager::addToRegistry(-1579,__construct_MeqCompiledFunklet)+
    0;
    return res;
  }
