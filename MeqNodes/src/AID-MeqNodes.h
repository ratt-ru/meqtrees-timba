...
#endif
#ifndef _defined_id_AidInterpolate
#define _defined_id_AidInterpolate 1
const DMI::AtomicID AidInterpolate(-1599);        // from /home/oms/LOFAR/Timba/MeqNodes/src/Resampler.h:32
const int AidInterpolate_int = -1599;
#endif
