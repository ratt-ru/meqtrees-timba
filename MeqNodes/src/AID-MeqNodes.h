...
const int AidMeqPointSourceDFT_int = -1405;
#endif
...
const DMI::AtomicID AidMeqStatPointSourceDFT(-1396);// from /home/oms/LOFAR/Timba/MeqNodes/src/StatPointSourceDFT.h:31
const int AidMeqStatPointSourceDFT_int = -1396;
#endif
