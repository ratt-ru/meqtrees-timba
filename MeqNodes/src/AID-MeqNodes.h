...
const DMI::AtomicID AidMeqCompiledFunklet(-1579); // from /home/mevius/exp_parm/LOFAR/Timba/MeqNodes/src/CompiledFunklet.h:18
const int AidMeqCompiledFunklet_int = -1579;
#endif
