//# MinLocation.h: Calculate station MinLocation from station position and phase center
//#
...
//#
//# $Id: MinLocation.h 3498 2006-04-27 12:37:39Z smirnov $

#ifndef MEQNODES_MinLocation_H
#define MEQNODES_MinLocation_H
    
#include <MEQ/TensorFunction.h>

#include <MeqNodes/TID-MeqNodes.h>
#pragma aidgroup MeqNodes
#pragma types #Meq::MinLocation

namespace Meq {    

class MinLocation : public TensorFunction
{
public:
  MinLocation();
...
protected:
  ...
  // method required by TensorFunction
  // Evaluates MinLocation for a given set of children values
