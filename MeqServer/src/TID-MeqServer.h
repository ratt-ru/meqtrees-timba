...
const DMI::TypeId TpMeqSink(-1399);               // from /home/oms/LOFAR/TIMBA/MeqServer/src/Sink.h:9
const int TpMeqSink_int = -1399;
...
const DMI::TypeId TpMeqSpigot(-1409);             // from /home/oms/LOFAR/TIMBA/MeqServer/src/Spigot.h:9
const int TpMeqSpigot_int = -1409;
