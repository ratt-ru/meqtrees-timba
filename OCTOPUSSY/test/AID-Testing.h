...
const AtomicID AidEchoWP(-1103);                  // from /home/oms/LOFAR/autoconf_share/../CEP/CPA/OCTOPUSSY/test/Testing.aidlist:3
const int AidEchoWP_int = -1103;
#endif
#ifndef _defined_id_AidInvert
#define _defined_id_AidInvert 1
const AtomicID AidInvert(-1106);                  // from /home/oms/LOFAR/autoconf_share/../CEP/CPA/OCTOPUSSY/test/Testing.aidlist:4
const int AidInvert_int = -1106;
#endif
#ifndef _defined_id_AidPing
#define _defined_id_AidPing 1
const AtomicID AidPing(-1109);                    // from /home/oms/LOFAR/autoconf_share/../CEP/CPA/OCTOPUSSY/test/Testing.aidlist:5
const int AidPing_int = -1109;
#endif
#ifndef _defined_id_AidPong
#define _defined_id_AidPong 1
const AtomicID AidPong(-1105);                    // from /home/oms/LOFAR/autoconf_share/../CEP/CPA/OCTOPUSSY/test/Testing.aidlist:6
const int AidPong_int = -1105;
#endif
#ifndef _defined_id_AidProcess
#define _defined_id_AidProcess 1
const AtomicID AidProcess(-1104);                 // from /home/oms/LOFAR/autoconf_share/../CEP/CPA/OCTOPUSSY/test/Testing.aidlist:7
const int AidProcess_int = -1104;
#endif
#ifndef _defined_id_AidReply
#define _defined_id_AidReply 1
const AtomicID AidReply(-1102);                   // from /home/oms/LOFAR/autoconf_share/../CEP/CPA/OCTOPUSSY/test/Testing.aidlist:8
