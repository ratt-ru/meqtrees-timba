...
static AtomicID::Register aid_reg_MsgLog(-1343,"MsgLog");
static AtomicID::Register aid_reg_LogNormal(-1348,"LogNormal");
static AtomicID::Register aid_reg_LogWarning(-1344,"LogWarning");
static AtomicID::Register aid_reg_LogError(-1347,"LogError");
static AtomicID::Register aid_reg_LogFatal(-1345,"LogFatal");
static AtomicID::Register aid_reg_LogDebug(-1346,"LogDebug");
