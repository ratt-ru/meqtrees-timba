...
\usepackage{graphicx,makeidx,epsfig}
%\usepackage{lscape} 
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/tree}}
\par}
...
\begin{figure}
{\par\centering
%\resizebox*{1.0\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/add}}
...
\begin{figure}
{\par\centering
\resizebox*{0.9\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/condeq}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.9\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/coeff}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.9\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/coeff_polcs}}
\par}
...
%\begin{figure}
%{\par\centering
%\resizebox*{1.0\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/solver1}}
%\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/browser1}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/browser2}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/browser3}}
\par}
\caption {The contents of the browser after the user has clicked on the
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/vells_0}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{1.0\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/browser4}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/array_browser}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{FiguresAndDiagrams/realvsimag.eps}}
\par}
...
\bibitem{rathmann} Rathmann, Uwe and Vermeulen, Gerard, 2005, http://qwt.sourceforge.net, http://pyqwt.sourceforge.net
\end{thebibliography}
