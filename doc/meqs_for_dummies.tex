...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{Figures/vells_0}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics[angle=-90]{Figures/AGW_diperr.ps}}
\par}
...
\begin{figure}
{\par\centering
\resizebox*{0.8\columnwidth}{!}{\includegraphics{Figures/errors.ps}}
\par}
