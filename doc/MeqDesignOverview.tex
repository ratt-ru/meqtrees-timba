...
\title{MeqTree Kernel Design Overview (PSS4)}
...
\subsection{HIIDs}
  ...
  all data-related indentifiers in the kernel. At core, a HIID is a vector of
  integers (a.k.a. atomic IDs). Negative atomic IDs map to symbolic 
  equivalents, while positive IDs are treated as integer indices. 
...
\section{Request IDs and the node cache}
...
\section{Next\_request and request sequences}
