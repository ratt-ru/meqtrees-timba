...
########################################
    ...
    def languageChange(self):
        ...
        self.imageBG.setTitle(self.__tr("Select Export Type"))
        ...
        self.ptableBG.setTitle(self.__tr("Select Export Type"))
        ...
        self.stableBG.setTitle(self.__tr("Select Export Type"))
